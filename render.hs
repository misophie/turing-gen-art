...
main states = reanimate $ scene $ do 
  ...
  play $ turingCanvas 60 (symbsAnimation states)
...
symbsAnimation :: [State] -> Animation
symbsAnimation (h:t) =  mkAnimation 600 $ -- anim code
 
  where 
    symb = generateSymbol (third h) 
